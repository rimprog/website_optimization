...
def add_comments_to_post(posts):
...
def index(request):
    ...
    most_popular_posts = add_comments_to_post(posts_filtered_by_likes[:5].prefetch_related('author'))
    ...
    most_popular_tags = tags_filtered_by_posts[:5]
